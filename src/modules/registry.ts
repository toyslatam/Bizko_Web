...
export const BUSINESS_MODULES: BusinessModuleConfig[] = [
  ...
  },
  {
    ...
    description: "Vehículos registrados y servicios de lavado.",
    plannedFeatures: ["Ficha de vehículo", "Combos de lavado", "Historial por placa"],
    navItems: [{ label: "Vehículos", href: "/vehiculos", icon: Bike }],
  },
  {
    type: "barbershop",
    slug: "barbershop",
  ...
  },
  {
    ...
    description: "Mascotas asociadas a cada cliente.",
    plannedFeatures: ["Ficha de mascota", "Recordatorio de vacunas", "Peluquería canina"],
    navItems: [{ label: "Mascotas", href: "/mascotas", icon: PawPrint }],
  },
  {
    type: "workshop",
    slug: "workshop",
    emoji: "🔧",
    name: "Taller",
    description: "Vehículos y órdenes de trabajo.",
    plannedFeatures: ["Ficha de vehículo", "Órdenes de trabajo", "Repuestos usados"],
    navItems: [
